<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="flex items-center justify-center mx-auto rounded-full size-16 bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600">
                                <img src="<?php echo e(URL::to('assets/images/adwords.png')); ?>" alt="" class="h-10 rounded-full">
                            </div>

                            <div class="mt-4 mb-6 text-center">
                                <h6 class="text-16"><a href="#!">Queen of Thrift</a></h6>
                                <p class="text-slate-500 dark:text-zink-200">Queen of Thrift</p>
                            </div>
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="flex items-center justify-center mx-auto rounded-full size-16 bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600">
                                <img src="<?php echo e(URL::to('assets/images/app-store.png')); ?>" alt="" class="h-10 rounded-full">
                            </div>
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="flex items-center justify-center mx-auto rounded-full size-16 bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600">
                                <img src="<?php echo e(URL::to('assets/images/meta.png')); ?>" alt="" class="h-10 rounded-full">
                            </div>
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="flex items-center justify-center mx-auto rounded-full size-16 bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600">
                                <img src="<?php echo e(URL::to('assets/images/search.png')); ?>" alt="" class="h-10 rounded-full">
                            </div>
    ...
    <?php $__env->startSection('script'); ?>
        <script src="<?php echo e(URL::to('assets/js/pages/apps-ecommerce-sellers.init.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alpcommerce\resources\views/ecommerce/sellers.blade.php ENDPATH**/ ?>