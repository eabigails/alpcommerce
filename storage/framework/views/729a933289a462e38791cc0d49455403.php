<?php $__env->startSection('content'); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 product_name">
                                        <a href="apps-ecommerce-product-overview.html" class="flex items-center gap-2">
                                            <img src="<?php echo e(URL::to('assets/images/img-012.png')); ?>" alt="Product images" class="h-6">
    ...
    <?php $__env->startSection('script'); ?>
        ...
        <script src="<?php echo e(URL::to('assets/js/pages/apps-ecommerce-product.init.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alpcommerce\resources\views/ecommerce/product/list.blade.php ENDPATH**/ ?>